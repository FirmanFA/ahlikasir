...
class LaporanPerbarangActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_laporan_perbarang)
        ...
        request.getPenjualan(email,tTglAwal.text.toString(),tTglAkhir.text.toString(),token).enqueue(object : Callback<List<Penjualan>> {
            override fun onResponse(call: Call<List<Penjualan>>?, response: Response<List<Penjualan>>?) {
                ...
                if(response!!.isSuccessful){
                    ...
                    val layoutmanager = LinearLayoutManager(this@LaporanPerbarangActivity)
            ...
            override fun onFailure(call: Call<List<Penjualan>>?, t: Throwable?) {
                val alert = AlertDialog.Builder(this@LaporanPerbarangActivity)
    ...
    fun setTglAwal(){
        tTglAwal.setOnClickListener {
            DatePickerDialog(this@LaporanPerbarangActivity, DatePickerDialog.OnDateSetListener { view, year, month, dayOfMonth ->
