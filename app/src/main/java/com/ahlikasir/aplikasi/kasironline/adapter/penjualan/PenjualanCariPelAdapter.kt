...
class PenjualanCariPelAdapter(val context: Context, val pelanggan: List<Pelanggan>, val itemClick:(Pelanggan)->Unit): RecyclerView.Adapter<PenjualanCariPelAdapter.Holder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): Holder {
        val view = LayoutInflater.from(context).inflate(R.layout.penjualan_pelanggan_list_layout,parent,false)
    ...
    class Holder(itemView: View?, val itemClick: (Pelanggan) -> Unit): RecyclerView.ViewHolder(itemView){
        ...
        fun bindPelanggan(pelanggan: Pelanggan, context: Context){
            ...
            itemView.setOnClickListener { itemClick(pelanggan) }
        }
    }
